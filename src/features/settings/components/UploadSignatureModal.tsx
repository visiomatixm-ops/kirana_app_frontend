 ...
 * ─────────────────────────────────────────────────────────────────────────────
 * Bottom-sheet action sheet for uploading a signature.
 * Converted from Figma CSS to responsive Flexbox TSX.
 * Slides up from the bottom with backdrop blur.
 *
 * Figma spec reference (393×171 sheet):
 *  - Title "Upload Your Signature" at top-center
 *  - X close button top-right
 *  - Separator line at ~66px
 *  - Camera option row at ~77px
 *  - Separator line at ~107px
 *  - Gallery option row at ~117px
 *  - Separator line at ~146px (bottom edge)
 */
